// Generated on 2015-07-14 using generator-ionic 0.7.3
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      styles: {
        files: ['<%= yeoman.app %>/<%= yeoman.styles %>/css/**/*.css'],
    ...
    injector: {
      ...
      css: {
        ...
        files: {
          '<%= yeoman.app %>/index.html': [
            '<%= yeoman.app %>/<%=yeoman.style %>/**/*.css',
            '!<%= yeoman.client %>/assets/css/angular*.css'
          ]
        }
      }
    },
    ...
    copy: {
      ...
      fonts: {
        expand: true,
        cwd: '<%= yeoman.app %>/lib/ionic/fonts/',
        dest: '<%= yeoman.dist %>/style/fonts/',
        src: '*'
      },
      vendor: {
        expand: true,
  ...
  grunt.registerTask('serve', function (target) {
   ...
   // grunt.task.run([ 'init', 'ionic:serve','concurrent:ionic']);
    grunt.task.run(['init', 'watch']);
  });
